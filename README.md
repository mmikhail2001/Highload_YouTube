...
Видеофайлы, исходные и обработанные, будут храниться в **объектом хранилище**. Атрибут videos.base_url является ссылкой на видеофайл в хранилище.
...
|Добавление комментария|800|**Селективный** запрос по video_id и инкремент поля|
...
Исходя из характера запросов и особенностей системы схему данных данных нужно денормализировать (см. физическую схему БД)
