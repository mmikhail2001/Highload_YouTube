...
|Пиковый исходящий трафик (Тбит / с)|60|
...
- **Пиковое потребление трафика** - 60 Тбит / с
	- Допустим, что пиковое (дневное) потребление в 1.8 раза больше среднего \[[27](https://cloud.mail.ru/public/8Mau/tKmAN3kqb)] (слайд 14), получим `(133 Пб/сутки + 25 Пб/сутки) * / 1024 Тб * 1.8 / 86400 * 8 = 30 Тбит / c`
	- Также учтем некоторый **запас** по потреблению трафика - x2. Таким образом, потребление **60 Тбит/c**. 
