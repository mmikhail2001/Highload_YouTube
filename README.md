...
| Vault       | Хранилище секретов| Специализированная БД для хранения секретов, поддержка полного жизненного цикла секрета, политики доступа \[[1](https://habr.com/ru/articles/306812/)] **Конкуренты**: облачные решения, хранение в репозитории |
