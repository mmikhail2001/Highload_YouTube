...
- Резервные копии файлов в S3 хранилище
...
- Взаимодействие между сервисами
	...
	- Установка дедлайнов по 99 персентилю, deadline propagation
	- Повторные запросы в рамках ограниченного времени 
...
- 540 серверов / 100 CDN = 6 серверов / CDN
...
- **S3**
	...
	- 180 Пб / год (? без учета резервных копий)
	- 180000 Тб / (24 * 16) = 470 серверов (? СХД)
...
- **Сервисы** - k8s
	...
	- 380 000 / 50 = 7600 CPU / 32 = 240 серверов
	- Конфигурация 1U **2x6338/16x128GB**/2xNVMe8T/2x40Gb/s
- **Balancers, API Gateway** 
	- Размещение - виртуальные машины
	- 500 RPS / CPU (табл)
	- 380 000 / 500 = 750 / 32 = 23 сервера
	- Конфигурация 1U **2x6338/16x128GB**/2xNVMe8T/**2x40Gb/s**
- 1233 U / 48 U/Rack = 25 стоек (1.5 ряда)
- Остальные AZ аналогичные, резервирование N + 2
